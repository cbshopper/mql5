...
public:
   ...
   void              SetOrderValues(int signal, ENUM_ORDERMODES mode, double price, double SLPrice, double TPPrice);
   void              SetOrderValues(int signal, ENUM_ORDERMODES mode, double price, int sl, int tp);
...
//|                                                                  |
//+------------------------------------------------------------------+
void CcbExpert::SetOrderValues(int signal, ENUM_ORDERMODES mode, double price, double SLPrice, double TPPrice)
  {
   calc_mode = BYPRICE;
   OrderMode = mode;
   slprice = SLPrice;
   ...
   if(price > 0)
      OpenPrice = price;
   Print(__FUNCTION__, " signal=", signal, " OrderMode=", OrderMode, " OpenPrice=", OpenPrice, " tpprice=", tpprice, " slprice=", slprice);
  }
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
...
//|                                                                  |
//+------------------------------------------------------------------+
void CcbExpert::SetOrderValues(int signal, ENUM_ORDERMODES mode, double price, int slticks, int tpticks)
  {
   calc_mode = BYPIPS;
   OrderMode = mode;

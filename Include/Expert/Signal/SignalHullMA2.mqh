...
//| Constructor                                                      |
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
CSignalHullMA2::CSignalHullMA2(void) : m_ma_period(12),
// m_ma_shift(0),
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
bool CSignalHullMA2::ValidationSettings(void)
  {
...
//+------------------------------------------------------------------+
int CSignalHullMA2::LongCondition(void)
  {
   int result=0;
   int idx   =StartIndex();
...
//+------------------------------------------------------------------+
int CSignalHullMA2::ShortCondition(void)
  {
   int result=0;
   int idx   =StartIndex();
//--- analyze positional relationship of the close price and the indicator at the first analyzed bar
